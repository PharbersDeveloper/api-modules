...
package object macros {
    ...
    def fromMongoDB[T: MongoDBConvert](mongo: DBObject): T = implicitly[MongoDBConvert[T]].fromMongo(mongo)
    def toMongoDB[T: MongoDBConvert](obj: T): DBObject = implicitly[MongoDBConvert[T]].toMongo(obj)
